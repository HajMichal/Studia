...
//     {
// 			base.Opis();
//       Console.WriteLine($"To jest kolczan z {Model}, sugerowana glebokosc kolczanu: {Glebokosc}");
//     }
// 	}

// 	// public interface IKolczan
// 	// {
// 	// 	void Kolczan(string nazwa, string adres, string nip, string rodzajStrzaly);
// 	// 	void Opis();
// 	// }
// }